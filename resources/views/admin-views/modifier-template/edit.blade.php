                        ...
                        @foreach($template->items as $index => $item)
                            <div class="row g-2 template-item-row mb-2" data-row="{{$index}}">
                                ...
                                <div class="col-md-2 d-flex align-items-center">
                                    <label class="mb-0"><input type="checkbox" name="items[{{$index}}][is_default]" {{$item->is_default ? 'checked' : ''}}> {{translate('Default')}}</label>
                                </div>
                                <div class="col-md-2 d-flex align-items-center justify-content-between">
                                    <label class="mb-0"><input type="checkbox" name="items[{{$index}}][is_active]" {{$item->is_active ? 'checked' : ''}}> {{translate('Active')}}</label>
