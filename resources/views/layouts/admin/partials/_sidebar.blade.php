...
{{--                        @endif--}}
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['product_management']))
                            ...
                            <!-- Pages -->
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/addon*') || Request::is('admin/modifier-template*') || Request::is('admin/product*') || Request::is('admin/attribute*') || Request::is('admin/reviews/list')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                >
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/product*') || Request::is('admin/addon*') || Request::is('admin/modifier-template*') || Request::is('admin/attribute*') || Request::is('admin/reviews*')?'block':'none'}}">
...
{{--                                    </li>--}}
                                    ...
                                    <li class="nav-item {{Request::is('admin/modifier-template*')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.modifier-template.index')}}"
                                           title="{{translate('Modifier Templates')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('Modifier_Templates')}}</span>
                                        </a>
                                    </li>
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['promotion_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/banner*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.banner.list')}}">
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('self_made_promo')}}</span>
                                </a>
                            </li>
