...
class ConfigController extends Controller
{
    ...
    public function configuration(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'restaurant_logo' => Helpers::get_restaurant_logo_filename(),
            'restaurant_light_logo' => Helpers::get_restaurant_logo_filename(),
            'restaurant_dark_logo' => Helpers::get_restaurant_logo_filename(true),
